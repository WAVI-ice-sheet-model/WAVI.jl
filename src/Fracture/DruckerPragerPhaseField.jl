export DruckerPragerPhaseField
...
"""
    update_strain_history!(fracture::DruckerPragerPhaseField,model::AbstractModel)

Advect the strain history neglecting all vertical shear.
"""
function update_strain_history!(fracture::DruckerPragerPhaseField,model::AbstractModel{T,N}) where {T,N} 
