...
"""
    update_shelf_melt_rate!(quad_melt_rate::QuadraticMeltRate, fields, grid, clock)

Wrapper script to update the melt rate under ice shelves for a QuadraticMeltRate.
"""
function update_shelf_melt_rate!(quad_melt_rate::QuadraticMeltRate, fields, grid, clock)
    ...
    set_quadratic_melt_rate!(shelf_basal_melt,
                            quad_melt_rate,
                            zb, 
                            grounded_fraction)
    return nothing
...
function set_quadratic_melt_rate!(shelf_basal_melt,
                                qmr,
                                zb, 
                                grounded_fraction)
