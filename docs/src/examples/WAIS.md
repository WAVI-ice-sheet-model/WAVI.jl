...
```
```@raw html
<center><img src="./assets/example-plots/WAIS/hmask_spy.png" alt="" title="" width="600" height="600" /></center>
```
...
```
```@raw html
<center><img src="./assets/example-plots/WAIS/WAIS_bed.png" alt="" title="" width="600" height="600" /></center>
```
...
```
```@raw html
<center><img src="./assets/example-plots/WAIS/WAIS_velocs.png" alt="" title="" width="600" height="600" /></center>
```
