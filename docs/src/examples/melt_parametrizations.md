...
```@raw html
<center><img src="./assets/example-plots//melt_parametrizations//quadratic.png" alt="" title="" width="600" height="600" /></center>
```

```@raw html
<center><img src="./assets/example-plots//melt_parametrizations//pico.png" alt="" title="" width="600" height="600" /></center>
```

```@raw html
<center><img src="./assets/example-plots//melt_parametrizations//plume.png" alt="" title="" width="600" height="600" /></center>
```

```@raw html
<center><img src="./assets/example-plots//melt_parametrizations//binary.png" alt="" title="" width="600" height="600" /></center>
```
...
```@raw html
<center><img src="./assets/example-plots//melt_parametrizations//mismip.png" alt="" title="" width="600" height="600" /></center>
```
