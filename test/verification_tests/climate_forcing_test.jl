...
using WAVI, NCDatasets, Test, Parameters
...
so = rand(Float32,grid.nx,grid.ny,nzforcing,2)
...
model = Model(grid,bed_elevation;initial_conditions,shelf_melt_rate,fracture,surface_mass_balance)
